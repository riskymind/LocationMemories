...
import com.asterisk.locationmemories.databinding.ActivityDisplayMapBinding
...
class DisplayMapActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(boundBuilder.build(), 100, 100, 0))
    }
}